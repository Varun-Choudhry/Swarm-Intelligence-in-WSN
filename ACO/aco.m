...
for a = 1 : size(ACOallpossiblesourceANDtargets,1)
...
if minVal < ACObestfitness
    ...
    counter=1;
    for a = 1 : length(ACOallpossibleshortestpaths)
        for b = 1 : size(ACOallpossibleshortestpaths(a).routes.Edges.EndNodes,1)
    ...
    for a = 1 : size(ACObesttournodes,1)
